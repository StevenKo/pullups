...
import com.kosbrother.pullups.training_session.TraingingActivity;
...
public class IndexTrainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        startSessionButton = (Button)fragment.findViewById(R.id.start_session_test);
        ...
        startRecordButton = (Button)fragment.findViewById(R.id.start_record_test);
        startRecordButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent proIntent = new Intent(getActivity(), TraingingActivity.class);
