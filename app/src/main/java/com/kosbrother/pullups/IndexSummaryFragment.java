...
public class IndexSummaryFragment extends Fragment implements OnChartValueSelectedListener,OnDrawListener {
    ...
    public static IndexSummaryFragment newInstance(String param1, String param2) {
        IndexSummaryFragment fragment = new IndexSummaryFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View summaryFragment = inflater.inflate(R.layout.fragment_index_summary, container, false);


        mChart = (BarChart) summaryFragment.findViewById(R.id.chart1);
