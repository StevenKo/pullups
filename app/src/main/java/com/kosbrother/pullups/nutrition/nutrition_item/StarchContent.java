...
public class StarchContent {
    ...
    public StarchContent(Context context){
        Resources resources = context.getResources();
        TypedArray rice_names = resources.obtainTypedArray(R.array.starch_names);
        TypedArray rice_gi_value = resources.obtainTypedArray(R.array.starch_gi_value);
        TypedArray rice_caloric = resources.obtainTypedArray(R.array.starch_caloric);
