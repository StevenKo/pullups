...
public class StemContent {
    ...
    public StemContent(Context context){
        Resources resources = context.getResources();
        TypedArray rice_names = resources.obtainTypedArray(R.array.stem_names);
        TypedArray rice_gi_value = resources.obtainTypedArray(R.array.stem_gi_value);
        TypedArray rice_caloric = resources.obtainTypedArray(R.array.stem_caloric);
