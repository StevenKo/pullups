...
public class GreensContent {
    ...
    public GreensContent(Context context){
        Resources resources = context.getResources();
        TypedArray rice_names = resources.obtainTypedArray(R.array.greens_names);
        TypedArray rice_gi_value = resources.obtainTypedArray(R.array.greens_gi_value);
        TypedArray rice_caloric = resources.obtainTypedArray(R.array.greens_caloric);
