...
public class MilkProductsContent {
    ...
    public MilkProductsContent(Context context){
        Resources resources = context.getResources();
        TypedArray rice_names = resources.obtainTypedArray(R.array.milk_names);
        TypedArray rice_gi_value = resources.obtainTypedArray(R.array.milk_gi_value);
        TypedArray rice_caloric = resources.obtainTypedArray(R.array.milk_caloric);
