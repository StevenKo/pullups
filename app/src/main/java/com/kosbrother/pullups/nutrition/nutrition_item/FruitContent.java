...
public class FruitContent {
    ...
    public FruitContent(Context context){
        Resources resources = context.getResources();
        TypedArray rice_names = resources.obtainTypedArray(R.array.fruit_names);
        TypedArray rice_gi_value = resources.obtainTypedArray(R.array.fruit_gi_value);
        TypedArray rice_caloric = resources.obtainTypedArray(R.array.fruit_caloric);
